...
This generates point geometries. This is often used in generating scatterplots. For example, using `dat` dataset to plot  female income (variable `B20004013`) vs male income (variable `B20004007`):
